({
	...
	init: function (cmp, event, helper) {
		...
		helper.serverSideCall(cmp, action).then(
			...
			function(result){
                ...
                //alert('TEST 1.1 '+caseObj.RecordTypeId);
                
                //alert('TEST 1.2 '+caseObj.Id);
                //alert('TEST 1.3 '+cmp.get("v.recordId"));
				helper.getCampaignList(cmp, event, helper);
                helper.getMedicalEnquiryCase(cmp, event, helper);
		...
		helper.getPROwnernamelist(cmp,event,helper);
        helper.getPRFollowernamelist(cmp,event,helper);
	...
	onChangeStatus: function (component, event, helper) {
		...
		if (value == 'Closed') {
			...
			component.set('v.inprogress_case_reason_disableField', false);
			...
			component.set('v.caseObj.Close_Case_Reason__c', '');
            component.set('v.caseObj.In_progress_reason__c', '');
		}
		// console.log(SubTaskMap[Main_Task__c]);
	},
	...
	onSave: function (component, event, helper) {
		...
		if (validate) {
            ...
            component.set('v.caseObj.First_Name_Existing_Patient__c', component.get('v.ExtPatientLastName'));
            component.set('v.caseObj.Gender_Existing_Patient__c', component.get('v.ExtPatientGender'));
            component.set('v.caseObj.Date_Of_Birth_Existing_Patient__c', component.get('v.ExtPatientDOB'));
            component.set('v.caseObj.Nationality_Existing_Patient__c', component.get('v.ExtPatientNationality'));
            component.set('v.caseObj.Country_of_Residence_Exisiting_Patient__c', component.get('v.ExtPatientCountry'));
            component.set('v.caseObj.Email_Existing_Patient__c', component.get('v.ExtPatientEmail'));
            component.set('v.caseObj.Primary_Phone_Existing_Patient__c', component.get('v.ExtPatientPrimaryPhone'));
    ...
    onChangePatientType : function (component, event, helper) {
        //alert("Test");
    	var value = event.getSource().get("v.value");
        if (value == 'New patient') {
            component.set('v.isShowTabNewPatient',true);
            component.set('v.isShowTabExistingPatient',false);
            //alert("Tab NewPatient1 = "+component.get('v.isShowTabNewPatient'));
            //alert("Tab NewPatient2 = "+component.get('v.isShowTabExistingPatient'));
        }else if(value == 'Existing patient'){
            component.set('v.isShowTabNewPatient',false);
            component.set('v.isShowTabExistingPatient',true);
            //alert("Tab Existing");
            //alert("Tab NewPatient2 = "+component.get('v.isShowTabExistingPatient'));
        }else{
            component.set('v.isShowTabNewPatient',false);

                        ...
                        if (state === "SUCCESS") {
                            ...
                            if (recordCaseId != undefined && recordCaseId != null) {
                                ...
                                setTimeout(() => {
                                   ...
                                   if (returnValues.DoctorObject2 != null) {
                                        component.set('v.doctorNameValue1', returnValues.DoctorObject2);
                                    } else {
                                        component.set('v.doctorNameValue1', null);
                                    }
                                    if (returnValues.DoctorObject3 != null) {
                                        component.set('v.doctorNameValue2', returnValues.DoctorObject3);
                                    } else {
                                        component.set('v.doctorNameValue2', null);
                                    }    
                                    // ////console.log('----003----');
...
getCampaignList: function (component, event, helper) {
    ...
    getreviewbylist: function (component, event, helper) {
        var action = component.get('c.getReviewByDetail');
        action.setCallback(this, function (response) {
            var state = response.getState();
            if (state === "SUCCESS") {
                //alert("Success");
                var returnValues = response.getReturnValue();
                //alert("Success1");
                component.set('v.ReviewByList', returnValues);
    ...
    getspecialtylist: function (component, event, helper) {
        var action = component.get('c.getSpecialtyDetail');
        action.setCallback(this, function (response) {
            var state = response.getState();
            if (state === "SUCCESS") {
                //alert("Success");
                var returnValues = response.getReturnValue();
                //alert("Success1");
                component.set('v.SpecialtyMedList', returnValues);
                //alert("Success2"+returnValues);
    ...
    getLikelyPrognosislist: function (component, event, helper) {
        var action = component.get('c.getLikelyProDetail');
        action.setCallback(this, function (response) {
            var state = response.getState();
            if (state === "SUCCESS") {
                //alert("Success");
                var returnValues = response.getReturnValue();
                //alert("Success1");
                component.set('v.LikelyPrognosisList', returnValues);
                //alert("Success2"+returnValues);
   ...
   getWhenConsultlist: function (component, event, helper) {
        var action = component.get('c.getWhenConsultDetail');
        action.setCallback(this, function (response) {
            var state = response.getState();
            if (state === "SUCCESS") {
                //alert("Success");
                var returnValues = response.getReturnValue();
                //alert("Success1");
                component.set('v.WhenConsultList', returnValues);
                //alert("Success2"+returnValues);
        ...
        getNationalitylist: function (component, event, helper) {
        var action = component.get('c.getNationalityDetail');
        action.setCallback(this, function (response) {
            var state = response.getState();
            if (state === "SUCCESS") {
                //alert("Success");
                var returnValues = response.getReturnValue();
                //alert("Success1");
                component.set('v.NationalityList', returnValues);
                //alert("Success2"+returnValues);

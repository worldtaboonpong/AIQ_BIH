...
//		helper.startSpinner(cmp);
		...
		helper.getreviewbylist(cmp, event, helper);
        helper.getspecialtylist(cmp, event, helper);
        helper.getLikelyPrognosislist(cmp, event, helper);
        helper.getWhenConsultlist(cmp, event, helper);
        helper.getNationalitylist(cmp, event, helper);
    ...
    onChangeDoctor1: function (component, event, helper) {
		var mapDoctor = component.get('v.MapDoctorAll');
		var doctorSelected = component.get('v.doctorNameValue1').Id;
        
        component.set('v.caseObj.Doctor_2__c',doctorSelected);
        
		var doctorSpecialty1 = mapDoctor[doctorSelected].Specialty__c;
		var doctorSpecialty2 = mapDoctor[doctorSelected].Specialty2__c;
        
        console.log('doctorSpecialty1=' + doctorSpecialty1);
		component.set('v.caseObj.Specialty_Doctor_3__c',doctorSpecialty1);
		component.set('v.caseObj.Specialty_Doctor_4__c',doctorSpecialty2);
        
	},
    onChangeDoctor2: function (component, event, helper) {
		var mapDoctor = component.get('v.MapDoctorAll');
		var doctorSelected = component.get('v.doctorNameValue2').Id;
        
        component.set('v.caseObj.Doctor_3__c',doctorSelected);
        
		var doctorSpecialty1 = mapDoctor[doctorSelected].Specialty__c;
		var doctorSpecialty2 = mapDoctor[doctorSelected].Specialty2__c;
        
        console.log('doctorSpecialty2=' + doctorSpecialty2);
		component.set('v.caseObj.Specialty_Doctor_5__c',doctorSpecialty1);
		component.set('v.caseObj.Specialty_Doctor_6__c',doctorSpecialty2);

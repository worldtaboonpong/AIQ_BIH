  ...
  /*  startSpinner: function (component) {
    ...
    getWrapper: function (component, event, helper) {
        ...
        actionPromise.then(
            ...
            function (res) {
               //////console.log('~~~~~~~~GetPIcklisValue wrapper called~~~~~~~END~~~~~~~~');
                        ...
                        if (state === "SUCCESS") {
                            ...
                            if (recordCaseId != undefined && recordCaseId != null) {
                                ...
                                setTimeout(() => {
                                    ...
                                    component.set('v.caseStaffValue', returnValues.StaffCurrentInfo); 
                                    component.set('v.caseInProgressByValue', returnValues.InProgressCurrentInfo);
                                    component.set('v.caseCompletedByValue', returnValues.CompletedCurrentInfo);    
                                    // ////console.log('----001----');
                              ...
                              setTimeout(() => {
                                ...
                                component.set('v.caseOwnerValue', returnValues.UserCurrentInfo);
                                component.set('v.caseStaffValue', returnValues.StaffCurrentInfo);
                                  console.log('InProgressCurrentInfo');
                                component.set('v.caseInProgressByValue', returnValues.InProgressCurrentInfo);  
                                component.set('v.caseCompletedByValue', returnValues.CompletedCurrentInfo);
                                ...
                                if (returnValues.UserCurrentInfo.Profile.Name.includes("Individual")){
                                    ...
                                    component.set('v.caseObj.RecordTypeId', getRecordTypeId);
                              	}else if (returnValues.UserCurrentInfo.Profile.Name.includes("Insurance")) {
                                    component.set('v.caseObj.Channel__c', "Insurance");
                                    component.set('v.caseObj.RecordTypeId', getRecordTypeId);  
                                ...
                                if (returnValues.UserCurrentInfo.Profile.Name == 'BIH Insurance - Pre-Auth'){
                        			component.set('v.isPreAuth', true);
                                    console.log('isPreAuth'+component.set('v.isPreAuth', true));
                                } else if (returnValues.UserCurrentInfo.Profile.Name == 'BIH Insurance - VOB'){
                                    component.set('v.isVOB', true);
                                    console.log('isVOB'+component.set('v.isVOB', true));
                                }  
...
getCampaignList: function (component, event, helper) {
    ...
    getPreferLanguagelist: function (component, event, helper) {
        var action = component.get('c.getPreferLangDetail');
        action.setCallback(this, function (response) {
            var state = response.getState();
            if (state === "SUCCESS") {
                //alert("Success");
                var returnValues = response.getReturnValue();
                //alert("Success1");
                component.set('v.PreferredLanguageList', returnValues);
       ...
       getInsuranceName1list: function (component, event, helper) {
        var action = component.get('c.getInsureName1Detail');
        action.setCallback(this, function (response) {
            var state = response.getState();
            if (state === "SUCCESS") {
                //alert("Success");
                var returnValues = response.getReturnValue();
                //alert("Success1");
                component.set('v.InsuranceName1List', returnValues);
                //alert("Success2"+returnValues);
   ...
   getInsuranceName2list: function (component, event, helper) {
        var action = component.get('c.getInsureName2Detail');
        action.setCallback(this, function (response) {
            var state = response.getState();
            if (state === "SUCCESS") {
                //alert("Success");
                var returnValues = response.getReturnValue();
                //alert("Success1");
                component.set('v.InsuranceName2List', returnValues);
                //alert("Success2"+returnValues);
 ...
 getInsuranceName3list: function (component, event, helper) {
        var action = component.get('c.getInsureName3Detail');
        action.setCallback(this, function (response) {
            var state = response.getState();
            if (state === "SUCCESS") {
                //alert("Success");
                var returnValues = response.getReturnValue();
                //alert("Success1");
                component.set('v.InsuranceName3List', returnValues);
                //alert("Success2"+returnValues);
    ...
    getClinicName1list: function (component, event, helper) {
        var action = component.get('c.getClinicName1Detail');
        action.setCallback(this, function (response) {
            var state = response.getState();
            if (state === "SUCCESS") {
                //alert("Success");
                var returnValues = response.getReturnValue();
                //alert("Success1");
                component.set('v.ClinicName1List', returnValues);
                //alert("Success2"+returnValues);
    ...
    getClinicName2list: function (component, event, helper) {
        var action = component.get('c.getClinicName2Detail');
        action.setCallback(this, function (response) {
            var state = response.getState();
            if (state === "SUCCESS") {
                //alert("Success");
                var returnValues = response.getReturnValue();
                //alert("Success1");
                component.set('v.ClinicName2List', returnValues);
                //alert("Success2"+returnValues);
    ...
    getClinicName3list: function (component, event, helper) {
        var action = component.get('c.getClinicName3Detail');
        action.setCallback(this, function (response) {
            var state = response.getState();
            if (state === "SUCCESS") {
                //alert("Success");
                var returnValues = response.getReturnValue();
                //alert("Success1");
                component.set('v.ClinicName3List', returnValues);
                //alert("Success2"+returnValues);
    ...
    getStationlist: function (component, event, helper) {
        var action = component.get('c.getStationDetail');
        action.setCallback(this, function (response) {
            var state = response.getState();
            if (state === "SUCCESS") {
                //alert("Success");
                var returnValues = response.getReturnValue();
                //alert("Success1");
                component.set('v.StationList', returnValues);
                //alert("Success2"+returnValues);
     ...
     getCustomerTypelist: function (component, event, helper) {
        var action = component.get('c.getCustomerTypeDetail');
        action.setCallback(this, function (response) {
            var state = response.getState();
            if (state === "SUCCESS") {
                //alert("Success");
                var returnValues = response.getReturnValue();
                //alert("Success1");
                component.set('v.CustomerTypeList', returnValues);
                //alert("Success2"+returnValues);
     ...
     getTaskItemlist: function (component, event, helper) {
        var action = component.get('c.getTaskItemDetail');
        action.setCallback(this, function (response) {
            var state = response.getState();
            if (state === "SUCCESS") {
                //alert("Success");
                var returnValues = response.getReturnValue();
                //alert("Success1");
                component.set('v.TaskitemList', returnValues);
                //alert("Success2"+returnValues);
     ...
     getTaskCategorylist: function (component, event, helper) {
        var action = component.get('c.getTaskCategoryDetail');
        action.setCallback(this, function (response) {
            var state = response.getState();
            if (state === "SUCCESS") {
                //alert("Success");
                var returnValues = response.getReturnValue();
                //alert("Success1");
                component.set('v.TaskcategoryList', returnValues);
                //alert("Success2"+returnValues);
   ...
   getTaskStatuslist: function (component, event, helper) {
        var action = component.get('c.getTaskStatusDetail');
        action.setCallback(this, function (response) {
            var state = response.getState();
            if (state === "SUCCESS") {
                //alert("Success");
                var returnValues = response.getReturnValue();
                //alert("Success1");
                component.set('v.TaskstatusList', returnValues);
                //alert("Success2"+returnValues);

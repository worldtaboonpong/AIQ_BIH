...
//		helper.startSpinner(cmp);
        ...
        helper.getInsuranceName1list(cmp, event, helper);
        helper.getInsuranceName2list(cmp, event, helper);
        helper.getInsuranceName3list(cmp, event, helper);
        helper.getClinicName1list(cmp, event, helper);
        helper.getClinicName2list(cmp, event, helper);
        helper.getClinicName3list(cmp, event, helper);
        helper.getStationlist(cmp, event, helper);
        helper.getCustomerTypelist(cmp, event, helper);
        helper.getTaskCategorylist(cmp, event, helper);
        helper.getTaskItemlist(cmp, event, helper);
        helper.getTaskStatuslist(cmp, event, helper);
    ...
    onChangeTaskCategory: function (component, event, helper) {
		var value = event.getSource().get("v.value");
		if (value == 'Others') {
			
			component.set('v.other_categories_disableField', false);
			
		} else {
			component.set('v.other_categories_disableField', true);
	...
	onSave: function (component, event, helper) {
		...
		if (validate) {
            ...
            component.set('v.caseObj.InProgressBy__c', component.get('v.caseInProgressByValue').Id);
           	component.set('v.caseObj.CompletedBy__c', component.get('v.caseCompletedByValue').Id);
